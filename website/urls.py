...
urlpatterns = [
    ...
    #       and you need to fire UV on little covid viruses to kill them all.
    ...
    # Dance floor - people can take videos of themselves and then the dance floor will be filled with GIFs of people dancing. 
    #       (Perhaps some moderation would be helpful)
